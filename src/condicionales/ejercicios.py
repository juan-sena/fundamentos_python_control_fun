...
#multiples instrucciones if-else
saldo = 300
retiro = 500
if saldo >= retiro:
    saldo -= retiro
...
#match-case con patrones anidados
usuarios = [
